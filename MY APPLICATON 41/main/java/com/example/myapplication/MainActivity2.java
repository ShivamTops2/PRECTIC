...
public class MainActivity2 extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, "https://vyasprakruti.000webhostapp.com/Test/API/view.php", new Response.Listener<String>() {
            @Override
            ...
            case 2:
                ...
                alert.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        StringRequest stringRequest=new StringRequest(Request.Method.POST, "https://vyasprakruti.000webhostapp.com/Test/API/delete.php", new Response.Listener<String>() {
                            @Override
                            public void onResponse(String response) {
