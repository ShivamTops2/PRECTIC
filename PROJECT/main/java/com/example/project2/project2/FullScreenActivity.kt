...
import com.example.project2.databinding.ActivityFullScreenBinding
...
class FullScreenActivity : AppCompatActivity()
{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        private fun getImageUri(fullScreenActivity: FullScreenActivity, bitmap: Bitmap): Uri?
        {
            ...
            val path: String = MediaStore.Images.Media.insertImage(fullScreenActivity.contentResolver, bitmap, "Greetings","")
