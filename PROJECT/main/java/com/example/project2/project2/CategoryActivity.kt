...
import com.example.project2.ApiClient
import com.example.project2.Apiinterface
import com.example.project2.R
import com.example.project2.databinding.ActivityCategoryBinding
...
class CategoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val rl: RecyclerView.LayoutManager = GridLayoutManager(applicationContext,3)
        ...
        if(pos==2)
        {
            val call = apiinterface!!.viewcategory_ganeshchartuthi
            call!!.enqueue(object : Call<List<Category_Model?>>,
                retrofit2.Callback<List<Category_Model?>?> {
                /*  override fun onResponse(call: Call<List<Model?>>, response: Response<List<Model?>>) {
                  }
